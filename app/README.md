...
back — with past chats behind the drawer, a lock-screen card while it runs, and the
...
DuckTalk/
  ...
  Corrections.swift        what the ears keep mishearing, and what you meant
...
Shared/                    compiled into both targets
  ...
  LiveSession.swift        the shape the app and the card agree on
  StopListening.swift      the two App Intents the card's buttons run
DuckTalkWidget/            the lock-screen card and the Dynamic Island pill
